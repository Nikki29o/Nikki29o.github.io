---
title: "UE 材质评测·展示场景与多光照版：23 个材质 × 4 种光照 + 完整可还原 JSON"
date: 2026-06-17T21:10:00+08:00
draft: false
description: "重搭专业材质展示场景：每个材质实例在方向光 / 点光源 / 聚光灯 / HDR 环境光四种条件下各渲一张，直观对比同一材质在不同光照下的表现差异；并把全部 UE 材质蓝图导出为完整、可重新导入还原的 JSON（节点连接图 + 标量/向量/纹理参数 + 纹理路径 + 实例覆写值）。"
tags: ["Unreal Engine", "Material", "Lighting", "Technical Art", "PBR", "Rendering", "JSON"]
